...
|---------|---------|--------|------|
| 🥚 VibePal | **AI 生活夥伴 × 七日孵化 × 全端產品** —— 結合靈獸孵化故事、互動成長與任務引導的沉浸式生活系統。<br>前端以 **Next.js（App Router）+ TypeScript + TailwindCSS** 打造高質感 UI，並整合 **Three.js / React Three Fiber / Framer Motion** 完成孵化與儀式動畫。<br>後端以 **Node.js + Express + MySQL + Prisma** 建構完整 API 與孵化邏輯，搭配配額控管、成就系統與管理後台。<br>串接 **Gumroad 金流**、會員專區與消費紀錄，完成完整產品流程。 | — | [Demo](https://vibe-pal.vercel.app/) |
